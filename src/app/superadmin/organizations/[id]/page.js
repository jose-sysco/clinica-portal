  ...
  const fetchOrg = async () => {
    try {
      ...
      setForm({
        ...
        trial_ends_at: r.data.trial_ends_at
          ? r.data.trial_ends_at.slice(0, 10)
          : "",
      });
    } catch {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (form.trial_ends_at)
        payload.trial_ends_at = new Date(form.trial_ends_at).toISOString();
      const r = await superadminApi.patch(
        `/api/superadmin/organizations/${id}/update_license`,
        payload,
      );
      setOrg(r.data);
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <span className="text-xs" style={{ color: "#475569" }}>
              {clinicTypeLabel[org.clinic_type]}
            </span>
            <span style={{ color: "#334155" }}>·</span>
            <span className="text-xs" style={{ color: "#475569" }}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        >
          ...
          {[
            ...
            { label: "Profesionales", value: org.doctors_count },
          ...
          {org.on_trial && (
            <>
              <div className="flex justify-between">
                ...
                <span
                  className="text-xs font-medium"
                  style={{ color: org.trial_expired ? "#ef4444" : "#f59e0b" }}
                >
              ...
              <div className="flex justify-between">
                ...
                <span
                  ...
                  style={{ color: org.trial_expired ? "#ef4444" : "#22c55e" }}
                >
                  {org.trial_expired
                    ? "Vencido"
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setForm({ ...form, trial_ends_at: e.target.value })
              }
              className="w-full text-sm px-3 py-2 rounded-lg outline-none"
              style={{
                backgroundColor: "#0f172a",
        ...
        <div className="flex flex-wrap gap-2 mb-5">
          <button
            onClick={() => {
              ...
              setForm({
                ...
                plan: "trial",
                status: "active",
                trial_ends_at: d.toISOString().slice(0, 10),
              });
            }}
          ...
          <button
            onClick={() =>
              setForm({ ...form, plan: "basic", status: "active" })
            }
            className="text-xs px-3 py-1.5 rounded-lg"
            style={{
          ...
          <button
            onClick={() =>
              setForm({ ...form, plan: "professional", status: "active" })
            }
            className="text-xs px-3 py-1.5 rounded-lg"
            style={{
            ...
            <tbody>
              {org.users.map((u, i) => (
                <tr
                  ...
                  style={{
                    borderBottom:
                      i < org.users.length - 1 ? "1px solid #1e293b" : "none",
                  }}
                >
