      ...
      {d != null && (
        <div style={{ display: "flex", alignItems: "center", gap: "5px" }}>
          ...
          <span style={{ fontSize: "11px", color: "#334155" }}>
            {prevLabel || `vs período anterior (${prev})`}
          </span>
        </div>
      )}
    </div>
...
export default function ReportsPage() {
  ...
  if (isLocked) {
    return (
      ...
      >
        ...
        >
          Los reportes avanzados están disponibles en los planes Profesional y
          Empresarial.
        </p>
        <a
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          {PERIODS.map((p) => (
            <button
              ...
              style={{
                ...
                fontWeight: "600",
                border:
                  period === p.key ? "1px solid #3b82f6" : "1px solid #334155",
      ...
      {/* Tabs */}
      <div
        style={{ display: "flex", gap: "0", borderBottom: "1px solid #1e293b" }}
      >
        {[
...
function SummaryTab({ data }) {
  ...
  const cancellationDelta = delta(
    s.cancellation_rate,
    s.prev_cancellation_rate,
  );
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      ...
      >
        ...
        <KpiCard
          ...
          color={
            s.completion_rate >= 80
              ? "#22c55e"
              : s.completion_rate >= 60
                ? "#f59e0b"
                : "#ef4444"
          }
        ...
        <KpiCard
          ...
          color={
            s.cancellation_rate <= 10
              ? "#22c55e"
              : s.cancellation_rate <= 20
                ? "#f59e0b"
                : "#ef4444"
          }
      ...
      <Card>
        <SectionHeader
          ...
          title="Estado de citas en el período"
        />
        <div
          style={{
            display: "grid",
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      <Card>
        <SectionHeader
          eyebrow="Rendimiento"
          title="Ranking de profesionales en el período"
        />
                ...
                return (
                  ...
                  >
                    <td style={{ padding: "14px 12px" }}>
                      ...
                      >
                        <span
                          style={{ fontSize: "11px", fontWeight: "800", color }}
                        >
                          {i + 1}
                        </span>
                      </div>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                ...
                >
                  ...
                  <div
                    style={{
                      width: "100%",
                      height: `${h}px`,
                      backgroundColor: isMax ? "#3b82f6" : "#334155",
      ...
      >
        <Card>
          <SectionHeader
            eyebrow="Tipos"
            title="Distribución por tipo de cita"
          />
          {pieData.length === 0 ? (
            ...
            <>
              ...
              >
                {by_type.map((r, i) => {
                  const pct =
                    totalTypes > 0
                      ? Math.round((r.count / totalTypes) * 100)
                      : 0;
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      <Card>
        ...
        <p style={{ fontSize: "13px", color: "#64748b", marginBottom: "20px" }}>
          Exporta los datos completos en formato CSV para análisis externo o
          reportes contables. Los archivos incluyen todos los registros, sin
          ...
          {[
            {
              ...
              description:
                "Todas las citas con profesional, paciente, tipo, estado y fecha",
              component: (
                <ExportCSVButton
            ...
            },
            {
              ...
              description:
                "Listado completo de pacientes con responsable y estado",
              component: (
                <ExportCSVButton
                  ...
                  prepare={(rows) =>
                    rows.map((r) => ({
                      ...r,
                      status: r.status === "active" ? "Activo" : "Inactivo",
                    }))
                  }
                />
              ),
