...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      {/* Panel izquierdo */}
      <div className="hidden lg:flex flex-col justify-between p-12" style={{ backgroundColor: '#18181b' }}>
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 bg-primary rounded-lg flex items-center justify-center">
            <span className="text-primary-foreground text-xs font-bold">C</span>
          </div>
          <span className="text-white font-semibold text-sm">Clínica Portal</span>
        </div>
        ...
        <div className="space-y-6">
          ...
          <p className="text-zinc-400 text-sm leading-relaxed">
            Administra doctores, pacientes y citas desde un solo lugar. Rápido, seguro y multitenant.
          </p>
          <div className="space-y-4 pt-4">
            {[
              { title: 'Agenda inteligente', desc: 'Disponibilidad en tiempo real sin conflictos' },
              { title: 'Multitenant',        desc: 'Una plataforma para todas tus clínicas' },
              { title: 'Notificaciones',     desc: 'Emails automáticos de confirmación' },
            ].map((f) => (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <input
                ...
                required
              />
              <p className="text-xs text-muted-foreground">El slug único de tu organización</p>
            </div>
